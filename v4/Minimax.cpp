...
Move Minimax::operator()() {
    ...
    for (int current_depth = 1; current_depth <= depth; ++current_depth) {
        ...
        for (int i = 0; i < moves.size(); ++i) {
            M_Node newNode = make_node(moves[i], playerId, node);
            int currentScore = minimax(newNode, current_depth - 1, !maximizingPlayer, !playerId);
        ...
        //because going one layer deeper takes approximately 100 times more time than the last layer
    }
